...
import { toggleAnimation, toggleLayout, toggleMenu, toggleNavbar, toggleRTL, toggleTheme, toggleSemidark, resetToggleSidebar } from '@/src/store/themeConfigSlice';
import IconSettings from '@/src/components/icon/icon-settings';
