import IconCalendar from '@/src/components/icon/icon-calendar';
import IconClock from '@/src/components/icon/icon-clock';
import IconCoffee from '@/src/components/icon/icon-coffee';
import IconCreditCard from '@/src/components/icon/icon-credit-card';
import IconDribbble from '@/src/components/icon/icon-dribbble';
import IconGithub from '@/src/components/icon/icon-github';
import IconMail from '@/src/components/icon/icon-mail';
import IconMapPin from '@/src/components/icon/icon-map-pin';
import IconPencilPaper from '@/src/components/icon/icon-pencil-paper';
import IconPhone from '@/src/components/icon/icon-phone';
import IconShoppingBag from '@/src/components/icon/icon-shopping-bag';
import IconTag from '@/src/components/icon/icon-tag';
import IconTwitter from '@/src/components/icon/icon-twitter';
import ComponentsUsersProfilePaymentHistory from '@/src/components/player/profile/components-users-profile-payment-history';
                    ...
                    <div className="panel">
                        ...
                        <div className="mb-5">
                            <div className="flex flex-col items-center justify-center">
                                <img src="/assets/images/user-profile.jpeg" alt="img" className="mb-5 h-24 w-24 rounded-full  object-cover" />
